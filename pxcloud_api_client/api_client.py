...
from pxcloud_api_client import rest
from pxcloud_api_client.configuration import Configuration
from pxcloud_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from pxcloud_api_client.model_utils import (
    ModelNormal, ModelSimple, ModelComposed, check_allowed_values,
    check_validations, date, datetime, deserialize_file, file_type,
...
class ApiClient(object):
    ...
    def __call_api(
        ...
        _request_timeout: typing.Optional[typing.Union[int, float,
                                                       typing.Tuple]] = None,
        _host: typing.Optional[str] = None,
        _check_type: typing.Optional[bool] = None,
        _content_type: typing.Optional[str] = None,
        _request_auths: typing.Optional[typing.List[typing.Dict[
            str, typing.Any]]] = None):
    ...
    def call_api(
        ...
        return self.pool.apply_async(
            ...
            (resource_path, method, path_params, query_params, header_params,
             ...
             _request_timeout, _host, _check_type, None, _request_auths))
    ...
    def select_header_content_type(self,
                                   content_types,
                                   method=None,
                                   body=None):
    ...
    def _apply_auth_params(self, headers, queries, resource_path, method, body,
        ...
        if auth_setting['in'] == 'cookie':
            headers[
                'Cookie'] = auth_setting['key'] + "=" + auth_setting['value']
...
class Endpoint(object):
    def __init__(self,
        ...
        self.params_map['all'].extend([
            ...
            '_check_return_type', '_content_type', '_spec_property_naming',
            '_request_auths'
        ])
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ComplianceApi()
        api_instance.asset_violations  # this is an instance of the class Endpoint
        api_instance.asset_violations()  # this invokes api_instance.asset_violations.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.asset_violations.callable or self.callable in this class
