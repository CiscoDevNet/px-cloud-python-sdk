...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CXMetaDataApi()
        api_instance.get_success_tracks  # this is an instance of the class Endpoint
        api_instance.get_success_tracks()  # this invokes api_instance.get_success_tracks.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_success_tracks.callable or self.callable in this class
