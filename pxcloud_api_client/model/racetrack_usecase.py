...
class RacetrackUsecase(ModelNormal):
    ...
    def _from_openapi_data(cls, name, description, usecase_id, current_pitstop,
                           pitstops, adoption_percentage, *args,
                           **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, usecase_id, current_pitstop,
                 pitstops, adoption_percentage, *args, **kwargs):  # noqa: E501
        """RacetrackUsecase - a model defined in OpenAPI
