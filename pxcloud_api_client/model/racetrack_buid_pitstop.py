...
class RacetrackBuidPitstop(ModelNormal):
    ...
    def _from_openapi_data(cls, name, description, is_complete,
                           pitstop_actions, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, is_complete, pitstop_actions, *args,
                 **kwargs):  # noqa: E501
        """RacetrackBuidPitstop - a model defined in OpenAPI
