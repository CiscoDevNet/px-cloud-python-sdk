...
class RacetrackBuidPitstopAction(ModelNormal):
    ...
    def _from_openapi_data(cls, name, description, is_manual_check_allowed,
                           is_complete, update_method, is_complete_auto,
                           is_complete_manual, is_manaual_override, tooltips,
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, is_manual_check_allowed, is_complete,
                 update_method, is_complete_auto, is_complete_manual,
                 is_manaual_override, tooltips, *args, **kwargs):  # noqa: E501
        """RacetrackBuidPitstopAction - a model defined in OpenAPI
