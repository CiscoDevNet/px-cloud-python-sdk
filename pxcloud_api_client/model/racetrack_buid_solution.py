...
class RacetrackBuidSolution(ModelNormal):
    ...
    def _from_openapi_data(cls, name, solution_id, description, cx_level,
                           usecases, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, solution_id, description, cx_level, usecases,
