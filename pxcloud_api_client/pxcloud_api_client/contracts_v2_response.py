        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ContractV2']:
                        return ContractV2
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ContractV2'], typing.List['ContractV2']],
                ...
                def __getitem__(self, i: int) -> 'ContractV2':
