...
class AssetError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["field", "message", "severity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["field", "message", "severity", ], str]):
