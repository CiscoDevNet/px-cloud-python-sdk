...
class SoftwareGroupBugsResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SoftwareGroupBugs']:
                        return SoftwareGroupBugs
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SoftwareGroupBugs'], typing.List['SoftwareGroupBugs']],
                ...
                def __getitem__(self, i: int) -> 'SoftwareGroupBugs':
