        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DeviceDetail']:
                        return DeviceDetail
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DeviceDetail'], typing.List['DeviceDetail']],
                ...
                def __getitem__(self, i: int) -> 'DeviceDetail':
