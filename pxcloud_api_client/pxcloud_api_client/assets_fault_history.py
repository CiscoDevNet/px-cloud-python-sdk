...
class AssetsFaultHistory(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status", "lastOccurrence", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status", "lastOccurrence", ], str]):
