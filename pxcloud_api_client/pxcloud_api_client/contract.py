...
class Contract(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contractNumber", "cuid", "cavid", "contractStatus", "contractValue", "customerName", "currency", "serviceLevel", "startDate", "endDate", "currencySymbol", "onboardedstatus", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contractNumber", "cuid", "cavid", "contractStatus", "contractValue", "customerName", "currency", "serviceLevel", "startDate", "endDate", "currencySymbol", "onboardedstatus", ], str]):
