...
class ContractDetailsV2Response(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ContractV2Details']:
                        return ContractV2Details
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ContractV2Details'], typing.List['ContractV2Details']],
                ...
                def __getitem__(self, i: int) -> 'ContractV2Details':
