        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FaultsSummary']:
                        return FaultsSummary
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FaultsSummary'], typing.List['FaultsSummary']],
                ...
                def __getitem__(self, i: int) -> 'FaultsSummary':
