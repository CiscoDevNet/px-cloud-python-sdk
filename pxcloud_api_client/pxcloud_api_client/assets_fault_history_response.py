...
class AssetsFaultHistoryResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AssetsFaultHistory']:
                        return AssetsFaultHistory
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AssetsFaultHistory'], typing.List['AssetsFaultHistory']],
                ...
                def __getitem__(self, i: int) -> 'AssetsFaultHistory':
