...
class CustomerInfo(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            customerEntryId = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["customerEntryId"]) -> MetaOapg.properties.customerEntryId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["companyName", "customerEntryId", "customerId", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["customerEntryId"]) -> typing.Union[MetaOapg.properties.customerEntryId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["companyName", "customerEntryId", "customerId", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        customerEntryId: typing.Union[MetaOapg.properties.customerEntryId, str, schemas.Unset] = schemas.unset,
