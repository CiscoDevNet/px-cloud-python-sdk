...
class SoftwareGroupFieldNoticesResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SoftwareGroupFieldNotices']:
                        return SoftwareGroupFieldNotices
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SoftwareGroupFieldNotices'], typing.List['SoftwareGroupFieldNotices']],
                ...
                def __getitem__(self, i: int) -> 'SoftwareGroupFieldNotices':
