...
class DeviceRiskFactorsResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DeviceRiskFactors']:
                        return DeviceRiskFactors
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['DeviceRiskFactors'], typing.List['DeviceRiskFactors']],
                ...
                def __getitem__(self, i: int) -> 'DeviceRiskFactors':
