...
SchemaFor200ResponseBodyApplicationJson = SoftwareGroupBugsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_software_group_suggestions_bugs_oapg(
        self,
...
class GetSoftwareGroupSuggestionsBugs(BaseApi):
    ...
    def get_software_group_suggestions_bugs(
        ...
        return self._get_software_group_suggestions_bugs_oapg(
