...
# Query params
ContractNumberSchema = schemas.Int32Schema
...
class OffsetSchema(
    ...
    class MetaOapg:
        format = 'int32'
        inclusive_minimum = 1
ComponentTypeSchema = schemas.StrSchema


class ContractLineItemTypeSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'contractNumber': typing.Union[ContractNumberSchema, decimal.Decimal, int, ],
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'componentType': typing.Union[ComponentTypeSchema, str, ],
        'contractLineItemType': typing.Union[ContractLineItemTypeSchema, str, ],
...
request_query_component_type = api_client.QueryParameter(
    name="componentType",
    style=api_client.ParameterStyle.FORM,
    schema=ComponentTypeSchema,
    explode=True,
)
request_query_contract_line_item_type = api_client.QueryParameter(
    name="contractLineItemType",
    style=api_client.ParameterStyle.FORM,
    schema=ContractLineItemTypeSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ContractDetailsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_contract_details_oapg(
        self,
    ...
    def _get_contract_details_oapg(
        ...
        for parameter in (
            ...
            request_query_component_type,
            request_query_contract_line_item_type,
...
class GetContractDetails(BaseApi):
    ...
    def get_contract_details(
        ...
        return self._get_contract_details_oapg(
