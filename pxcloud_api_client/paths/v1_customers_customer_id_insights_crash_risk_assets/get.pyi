...
SchemaFor200ResponseBodyApplicationJson = CrashRiskDevices
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_crash_risk_assets_oapg(
        self,
...
class GetCrashRiskAssets(BaseApi):
    ...
    def get_crash_risk_assets(
        ...
        return self._get_crash_risk_assets_oapg(
