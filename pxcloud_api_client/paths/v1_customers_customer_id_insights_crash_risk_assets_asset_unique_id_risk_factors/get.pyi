...
SchemaFor200ResponseBodyApplicationJson = DeviceRiskFactorsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_crash_risk_asset_risk_factors_oapg(
        self,
...
class GetCrashRiskAssetRiskFactors(BaseApi):
    ...
    def get_crash_risk_asset_risk_factors(
        ...
        return self._get_crash_risk_asset_risk_factors_oapg(
