...
SchemaFor200ResponseBodyApplicationJson = FaultsSummaryResponse
...
class GetFaultSummary(BaseApi):
    ...
    def get_fault_summary(
        ...
        return self._get_fault_summary_oapg(
