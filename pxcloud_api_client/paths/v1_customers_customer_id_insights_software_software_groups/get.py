...
SchemaFor200ResponseBodyApplicationJson = SoftwareGroupResponse
...
class GetSoftwareGroups(BaseApi):
    ...
    def get_software_groups(
        ...
        return self._get_software_groups_oapg(
