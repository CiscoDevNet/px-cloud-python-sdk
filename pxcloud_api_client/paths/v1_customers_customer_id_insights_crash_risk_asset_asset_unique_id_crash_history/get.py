...
SchemaFor200ResponseBodyApplicationJson = DeviceCrashDetail
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_crash_asset_crash_history_oapg(
        self,
...
class GetCrashAssetCrashHistory(BaseApi):
    ...
    def get_crash_asset_crash_history(
        ...
        return self._get_crash_asset_crash_history_oapg(
