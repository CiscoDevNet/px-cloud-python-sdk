...
SchemaFor200ResponseBodyApplicationJson = PartnerAssetResponse
...
class GetPartnerOffers(BaseApi):
    ...
    def get_partner_offers(
        ...
        return self._get_partner_offers_oapg(
