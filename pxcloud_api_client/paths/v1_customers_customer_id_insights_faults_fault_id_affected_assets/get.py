...
SchemaFor200ResponseBodyApplicationJson = AffectedAssetsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_fault_affected_assets_oapg(
        self,
...
class GetFaultAffectedAssets(BaseApi):
    ...
    def get_fault_affected_assets(
        ...
        return self._get_fault_affected_assets_oapg(
