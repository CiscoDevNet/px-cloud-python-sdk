...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'timePeriod': typing.Union[TimePeriodSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = InventoryCrashDetails
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_crash_risk_assets_crashed_oapg(
        self,
...
class ListCrashRiskAssetsCrashed(BaseApi):
    ...
    def list_crash_risk_assets_crashed(
        ...
        return self._list_crash_risk_assets_crashed_oapg(
