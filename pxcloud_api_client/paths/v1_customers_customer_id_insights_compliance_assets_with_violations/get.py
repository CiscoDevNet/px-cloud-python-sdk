...
SchemaFor200ResponseBodyApplicationJson = AssetsWithViolationsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_assets_with_violations_oapg(
        self,
...
class GetAssetsWithViolations(BaseApi):
    ...
    def get_assets_with_violations(
        ...
        return self._get_assets_with_violations_oapg(
