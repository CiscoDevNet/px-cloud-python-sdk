...
SourceSystemIdSchema = schemas.StrSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'sourceSystemId': typing.Union[SourceSystemIdSchema, str, ],
...
request_query_source_system_id = api_client.QueryParameter(
    name="sourceSystemId",
    style=api_client.ParameterStyle.FORM,
    schema=SourceSystemIdSchema,
    required=True,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = AssetViolationsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_asset_violations_oapg(
        self,
    ...
    def _get_asset_violations_oapg(
        ...
        for parameter in (
            ...
            request_query_source_system_id,
...
class GetAssetViolations(BaseApi):
    ...
    def get_asset_violations(
        ...
        return self._get_asset_violations_oapg(
