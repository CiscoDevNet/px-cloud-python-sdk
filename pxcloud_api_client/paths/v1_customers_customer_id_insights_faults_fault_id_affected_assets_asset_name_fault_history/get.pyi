...
FaultIdSchema = schemas.IntSchema
AssetNameSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'customerId': typing.Union[CustomerIdSchema, str, ],
        'faultId': typing.Union[FaultIdSchema, decimal.Decimal, int, ],
        'assetName': typing.Union[AssetNameSchema, str, ],
    }
)
...
request_path_fault_id = api_client.PathParameter(
    name="faultId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FaultIdSchema,
    required=True,
)
request_path_asset_name = api_client.PathParameter(
    name="assetName",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AssetNameSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = AssetsFaultHistoryResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_fault_history_oapg(
        ...
        for parameter in (
            ...
            request_path_fault_id,
            request_path_asset_name,
        ):
...
class GetFaultHistory(BaseApi):
    ...
    def get_fault_history(
        ...
        return self._get_fault_history_oapg(
