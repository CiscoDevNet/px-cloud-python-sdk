...
SchemaFor200ResponseBodyApplicationJson = PolicyRuleDetails
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_policy_rule_details_oapg(
        self,
...
class GetPolicyRuleDetails(BaseApi):
    ...
    def get_policy_rule_details(
        ...
        return self._get_policy_rule_details_oapg(
