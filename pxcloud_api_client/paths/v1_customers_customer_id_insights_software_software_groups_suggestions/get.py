...
SuggestionIdSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'successTrackId': typing.Union[SuccessTrackIdSchema, str, ],
        'suggestionId': typing.Union[SuggestionIdSchema, str, ],
    }
)
...
request_query_suggestion_id = api_client.QueryParameter(
    name="suggestionId",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = SoftwareGroupSuggestions
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_software_group_suggestions_oapg(
        self,
...
class GetSoftwareGroupSuggestions(BaseApi):
    ...
    def get_software_group_suggestions(
        ...
        return self._get_software_group_suggestions_oapg(
