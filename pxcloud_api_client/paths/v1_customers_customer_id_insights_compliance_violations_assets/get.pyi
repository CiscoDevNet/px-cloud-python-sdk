...
PolicyCategorySchema = schemas.StrSchema
PolicyGroupIdSchema = schemas.StrSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'policyCategory': typing.Union[PolicyCategorySchema, str, ],
        'policyGroupId': typing.Union[PolicyGroupIdSchema, str, ],
...
request_query_policy_category = api_client.QueryParameter(
    name="policyCategory",
    style=api_client.ParameterStyle.FORM,
...
request_query_policy_group_id = api_client.QueryParameter(
    name="policyGroupId",
    style=api_client.ParameterStyle.FORM,
    schema=PolicyGroupIdSchema,
    required=True,
    explode=True,
)
...
request_query_rule_id = api_client.QueryParameter(
    name="ruleId",
    style=api_client.ParameterStyle.FORM,
    schema=RuleIdSchema,
    required=True,
...
SchemaFor200ResponseBodyApplicationJson = AssetsViolationsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_violations_assets_oapg(
        self,
    ...
    def _get_violations_assets_oapg(
        ...
        for parameter in (
            ...
            request_query_policy_category,
            request_query_policy_group_id,
            request_query_policy_id,
            request_query_rule_id,
...
class GetViolationsAssets(BaseApi):
    ...
    def get_violations_assets(
        ...
        return self._get_violations_assets_oapg(
