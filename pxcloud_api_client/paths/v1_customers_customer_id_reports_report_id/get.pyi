...
SchemaFor200ResponseBodyApplicationJson = ReportStatus
...
ResponseHeadersFor303 = typing_extensions.TypedDict(
...
class GetReportStatus(BaseApi):
    ...
    def get_report_status(
        ...
        return self._get_report_status_oapg(
