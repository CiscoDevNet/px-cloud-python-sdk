...
SchemaFor200ResponseBodyApplicationJson = SuccessTracksResponse
...
class GetSuccessTracks(BaseApi):
    ...
    def get_success_tracks(
        ...
        return self._get_success_tracks_oapg(
