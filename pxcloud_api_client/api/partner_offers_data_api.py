...
class PartnerOffersDataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.partner_offers_endpoint = _Endpoint(settings={
    ...
    def partner_offers(self, **kwargs):
        """Get Partner Offers  # noqa: E501

        Get all the Partner Offers data  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.partner_offers(async_req=True)
        >>> result = thread.get()
        ...
        return self.partner_offers_endpoint.call_with_http_info(**kwargs)
