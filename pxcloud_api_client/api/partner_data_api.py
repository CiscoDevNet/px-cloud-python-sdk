...
class PartnerDataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contract_details2_endpoint = _Endpoint(
            settings={
                'response_type': (ContractDetailsV2Response,),
                'auth': [
                    'oAuth2'
                ],
                'endpoint_path': '/v2/contract/details',
                'operation_id': 'contract_details2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_contracts_v2_endpoint = _Endpoint(
            settings={
    ...
    def contract_details2(
        self,
        contract_number,
        **kwargs
    ):
        """Get contract details V2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contract_details2(contract_number, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['contract_number'] = \
            contract_number
        return self.contract_details2_endpoint.call_with_http_info(**kwargs)
    ...
    def get_contract_details(
        ...
        **kwargs
        ...
        >>> thread = api.get_contract_details(contract_number, async_req=True)
        >>> result = thread.get()
    ...
    def get_contracts_v2(
        self,
        **kwargs
    ):
        """List customer contracts V2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_contracts_v2(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_contracts_v2_endpoint.call_with_http_info(**kwargs)
    ...
    def get_contracts_with_customers(
        ...
        **kwargs
        ...
        >>> thread = api.get_contracts_with_customers(async_req=True)
        >>> result = thread.get()
    ...
    def get_partner_offers_sessions(
        ...
        **kwargs
        ...
        >>> thread = api.get_partner_offers_sessions(async_req=True)
        >>> result = thread.get()
