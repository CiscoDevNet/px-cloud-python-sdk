...
class PartnerDataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.success_tracks_endpoint = _Endpoint(settings={
            'response_type': None,
            'auth': ['oAuth2'],
            'endpoint_path': '/v1/successTracks',
            'operation_id': 'success_tracks',
            'http_method': 'GET',
            'servers': None,
        },
                                                 params_map={
    ...
    def success_tracks(self, **kwargs):
        ...
        >>> thread = api.success_tracks(async_req=True)
        >>> result = thread.get()
        ...
        return self.success_tracks_endpoint.call_with_http_info(**kwargs)
