...
class CustomersAPIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.customers_endpoint = _Endpoint(settings={
    ...
    def customers(self, **kwargs):
        ...
        >>> thread = api.customers(async_req=True)
        >>> result = thread.get()
        ...
        return self.customers_endpoint.call_with_http_info(**kwargs)
