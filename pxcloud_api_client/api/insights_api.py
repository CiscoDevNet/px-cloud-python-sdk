...
class InsightsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.software_group_assets_endpoint = _Endpoint(
            settings={
                ...
                'auth': ['oAuth2'],
                'endpoint_path':
                '/v1/customers/{customerId}/insights/software/softwareGroups/assets',
        ...
        self.software_group_field_notices_endpoint = _Endpoint(
            settings={
                ...
                'auth': ['oAuth2'],
                'endpoint_path':
                '/v1/customers/{customerId}/insights/software/softwareGroups/suggestions/fieldNotices',
        ...
        self.software_group_security_advisories_endpoint = _Endpoint(
            settings={
                ...
                'auth': ['oAuth2'],
                'endpoint_path':
                '/v1/customers/{customerId}/insights/software/softwareGroups/suggestions/securityAdvisories',
        ...
        self.software_group_suggestions_endpoint = _Endpoint(
            settings={
                ...
                'auth': ['oAuth2'],
                'endpoint_path':
                '/v1/customers/{customerId}/insights/software/softwareGroups/suggestions',
        ...
        self.software_group_suggestions_bugs_endpoint = _Endpoint(
            settings={
                ...
                'auth': ['oAuth2'],
                'endpoint_path':
                '/v1/customers/{customerId}/insights/software/softwareGroups/suggestions/bugs',
    ...
    def software_group_assets(self, customer_id, success_track_id,
                              software_group_id, **kwargs):
        ...
        kwargs['software_group_id'] = \
            software_group_id
        return self.software_group_assets_endpoint.call_with_http_info(
            **kwargs)

    def software_group_field_notices(self, customer_id, success_track_id,
                                     machine_suggestion_id, **kwargs):
        ...
        kwargs['machine_suggestion_id'] = \
            machine_suggestion_id
        return self.software_group_field_notices_endpoint.call_with_http_info(
            **kwargs)

    def software_group_security_advisories(self, customer_id, success_track_id,
                                           machine_suggestion_id, **kwargs):
        ...
        kwargs['machine_suggestion_id'] = \
            machine_suggestion_id
        return self.software_group_security_advisories_endpoint.call_with_http_info(
            **kwargs)

    def software_group_suggestions(self, customer_id, success_track_id,
                                   suggestion_id, **kwargs):
        ...
        kwargs['suggestion_id'] = \
            suggestion_id
        return self.software_group_suggestions_endpoint.call_with_http_info(
            **kwargs)

    def software_group_suggestions_bugs(self, customer_id, success_track_id,
                                        machine_suggestion_id, **kwargs):
        ...
        kwargs['machine_suggestion_id'] = \
            machine_suggestion_id
        return self.software_group_suggestions_bugs_endpoint.call_with_http_info(
            **kwargs)

    def software_groups(self, success_track_id, customer_id, **kwargs):
