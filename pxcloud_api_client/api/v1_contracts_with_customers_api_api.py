...
class V1ContractsWithCustomersAPIApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.contracts_with_customers_endpoint = _Endpoint(
            settings={
                'response_type': (ContractsV2Response, ),
                'auth': ['oAuth2'],
                'endpoint_path': '/v1/contractsWithCustomers',
                'operation_id': 'contracts_with_customers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'openapi_types': {
                    ...
                    'offset': (int, ),
                    'customer_id': (str, ),
                    'customer_gu_name': (str, ),
                    'success_track_id': (int, ),
                },
                'attribute_map': {
                    'max': 'max',
                    'offset': 'offset',
    ...
    def contracts_with_customers(self, **kwargs):
        """Get the Outbound Contracts With Customers  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contracts_with_customers(async_req=True)
        >>> result = thread.get()
        ...
        return self.contracts_with_customers_endpoint.call_with_http_info(
            **kwargs)
