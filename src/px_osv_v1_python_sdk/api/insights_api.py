...
class InsightsApi(object):
    ...
    def get_software_group_assets_using_get(
        ...
        **kwargs
        ...
        >>> thread = api.get_software_group_assets_using_get(success_track_id, customer_id, software_group_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_software_groups_using_get(
        ...
        **kwargs
        ...
        >>> thread = api.get_software_groups_using_get(success_track_id, customer_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['customer_id'] = \
            customer_id
        return self.get_software_groups_using_get_endpoint.call_with_http_info(**kwargs)
