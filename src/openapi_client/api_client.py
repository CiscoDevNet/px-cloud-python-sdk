...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ContractsDataApi()
        api_instance.fetch_contracts_summary_using_get  # this is an instance of the class Endpoint
        api_instance.fetch_contracts_summary_using_get()  # this invokes api_instance.fetch_contracts_summary_using_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.fetch_contracts_summary_using_get.callable or self.callable in this class
